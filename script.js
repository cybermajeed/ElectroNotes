...
//search
const searchIcon = `<svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 0 24 24" width="30px" fill="#FFFFFF">
<path d="M0 0h24v24H0V0z" fill="none"/>
...
function navCloseOpen() {
  if (topNavParent.querySelector("div.hideSidebar svg").classList.contains("navClose")) {
    topNavParent
